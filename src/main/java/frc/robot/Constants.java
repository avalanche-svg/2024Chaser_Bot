...
public final class Constants {
  ...
  public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(333.545); // DONE Measure and set front
                                                                                       // left steer offset
  ...
  public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(262.617); // DONE Measure and set front
                                                                                       // right steer offset
  ...
  public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(119.619); // DONE Measure and set back
                                                                                    // left steer offset
  ...
  public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(47.021); // DONE Measure and set back
                                                                                       // right steer offset
